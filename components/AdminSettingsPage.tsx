...
import { SettingsIcon, CheckCircleIcon, XCircleIcon, ZapIcon, LayoutDashboard, Network, MessageSquare, MenuIcon, CloseIcon, ShieldCheckIcon, RefreshIcon, ViewfinderIcon, AlertTriangleIcon } from './icons';
                                ...
                                <div className="space-y-3 pl-4 border-l-2 border-gray-700 ml-1">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setSettings({
                                                ...settings,
                                                resilience: { ...settings.resilience!, pauseOnLocalFailure: e.target.checked }
                                            })}
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setSettings({
                                                ...settings,
                                                resilience: { ...settings.resilience!, checkActiveJobOnRecovery: e.target.checked }
                                            })}
                                            className="h-5 w-5 rounded-md border-gray-500 bg-gray-700 text-indigo-600 focus:ring-indigo-500 cursor-pointer"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                onChange={e => setSettings({
                                                    ...settings,
                                                    resilience: { ...settings.resilience!, checkBackendInterval: parseInt(e.target.value) }
                                                })}
                                ...
                                <div className="space-y-3 pl-4 border-l-2 border-gray-700 ml-1">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <input
                                            ...
                                            onChange={e => setSettings({
                                                ...settings,
                                                resilience: { ...settings.resilience!, failoverEnabled: e.target.checked }
                                            })}
                                            className="h-5 w-5 rounded-md border-gray-500 bg-gray-700 text-indigo-600 focus:ring-indigo-500 cursor-pointer"
                                        />
                                    </div>
