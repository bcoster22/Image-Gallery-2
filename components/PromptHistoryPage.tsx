...
import { ClipboardIcon as CopyIcon, MagnifyingGlassIcon as SearchIcon, XMarkIcon as CloseIcon, SparklesIcon, VideoCameraIcon } from '@heroicons/react/24/outline';
