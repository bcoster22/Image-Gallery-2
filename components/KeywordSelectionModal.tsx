...
import { XMarkIcon as CloseIcon, SparklesIcon } from '@heroicons/react/24/outline';
...
const KeywordSelectionModal: React.FC<KeywordSelectionModalProps> = ({ isOpen, onClose, onSubmit, keywords }) => {
    ...
    return (
        <Modal
            ...
            onClose={onClose}
            maxWidth="max-w-2xl"
            panelClassName="bg-gray-800 rounded-lg shadow-xl border border-gray-700 relative flex flex-col max-h-[90vh] p-0"
