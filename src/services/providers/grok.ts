...
export const testConnection = async (settings: AdminSettings): Promise<void> => {
    ...
    try {
        ...
        throw new Error(error.message || "Failed to connect to Grok API.");
    }
};
...
export const animateImage = async (
  ...
  throw new Error("Video animation is not supported by the Grok provider.");
};
...
export const editImage = async (
  ...
  settings: AdminSettings
    ...
    throw new Error("Image editing is not supported by the Grok provider.");
}
