...
export const extractAIGenerationMetadata = async (file: File): Promise<{ recreationPrompt?: string; keywords?: string[] } | null> => {
            ...
            while (offset < dataView.byteLength) {
                ...
                if (type === 'tEXt') {
                    ...
                    if (keyword === 'parameters') {
                        ...
                        if (prompt) {
                            // We don't get keywords from this, but we have the most important part.
                            resolve({ recreationPrompt: prompt });
                            return;
                        }
                    }
                }
